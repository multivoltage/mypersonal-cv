    ...
    return (
      ...
      >
        ...
        <div className="content--wrapper">
          <p className="content--wrapper__job">
            {jobTitle} - {agency}
          </p>
          <p className="content--wrapper__period">
            <i class="material-icons">date_range</i>
            <span className="experience--startDate">
              {startDate} - {endDate}
            </span>
          </p>
          ...
          {shortDescription && (
            <p className="content--wrapper__description">
          ...
          {skillsTags.length && (
            <p className="content--wrapper__skillsTags">
          ...
          {projects.length > 0 && (
            <p className="content--wrapper_projects">
